                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              ...
                              const Padding(
                                ...
                                child: Text("Chứng nhận ngừa Covid",style: TextStyle(
                          ...
                          const Padding(
                            ...
                            child: Text("ĐÃ TIÊM 02 MŨI VẮC XIN",style: TextStyle(
                                ...
                                child: Column(
                                  children: [
                                      ...
                                      child: Row(
                                        children: const [
                                          ...
                                          Padding(
                                            ...
                                            child: Text('Họ tên',style: TextStyle(
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: const [
                                          Text('Trần Hoài Sơn',style: TextStyle(
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: const [
                                          Icon(Icons.date_range,size: 30,color: Colors.black54,),
                                          Padding(
                                            padding: EdgeInsets.only(left: 8.0),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: const [
                                          Text('12/07/2001',style: TextStyle(
                                            fontSize: 20,color: Colors.black,),)
                                        ],
                                      ),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: const [
                                          Icon(Icons.add_card_outlined,size: 30,color: Colors.black54,),
                                          Padding(
                                            padding: EdgeInsets.only(left: 8.0),
                                            child: Text('Số hộ chiếu/CMND/CCCD',style: TextStyle(
                                              fontSize: 20,color: Colors.black54,),
                                            ),
                                          )
                                        ],
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: const [
                                          Text('21235648243',style: TextStyle(
                                            fontSize: 20,color: Colors.black,),)
                                        ],
                                      ),
